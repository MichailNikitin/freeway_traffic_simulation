...
NK_API void nk_set_theme(struct nk_context *ctx, enum nk_theme theme);

/*
  GDI
*/

NK_API struct nk_context* nk_gdi_init(unsigned int width, unsigned int height, const char* name);
NK_API void nk_gdi_render(struct nk_color clear);
NK_API void nk_gdi_shutdown(void);

/* font */
typedef void* nk_gdifont;
NK_API nk_gdifont nk_gdifont_create(const char *name, int size);
NK_API void nk_gdi_dispatch(struct nk_context *ctx, int *running);
NK_API void nk_gdifont_del(nk_gdifont font);
NK_API void nk_gdi_set_font(nk_gdifont font);

NK_API void nk_gdi_release(void);
